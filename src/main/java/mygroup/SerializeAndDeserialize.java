...
public class SerializeAndDeserialize {
    ...
    public static void main(String[] args) {
        Employee2 e1 = new Employee2(1, 11111, "David", "Wang");
        Employee2 e2 = new Employee2(2, 22222, "Ryo", "Hang");
        Employee2 e3 = null;
        Employee2 e4 = null;
        ...
        try {
            ...
            e3 = (Employee2)objectIn.readObject();
            e4 = (Employee2)objectIn.readObject();
            objectIn.close();
            fileIn.close();
...
class Employee2 implements Comparable<Object>, Comparator<Employee2>, Serializable {
    ...
    public Employee2(int id, int ssn, String firstName, String lastName) {
        this.id = id;
        this.ssn = ssn;
